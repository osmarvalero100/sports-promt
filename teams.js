...
const uefaTier1_2 = ["Alavés", "Athletic Club", "Atlético Madrid", "Barcelona", "Celta Vigo","Málaga CF", "Espanyol", "Getafe", "Girona", "Las Palmas", "Leganés", "Mallorca", "Osasuna", "Rayo Vallecano", "Real Betis", "Real Madrid", "Real Sociedad", "Sevilla", "Valencia", "Valladolid", "Villarreal"];
...
const uefaTier1_4 = ["Augsburg", "Bayer Leverkusen", "Bayern Munich", "Paderborn","Colonia", "Bochum", "Werder Bremen", "Borussia Dortmund", "Eintracht Frankfurt", "Freiburg", "Heidenheim","Hamburgo", "Hoffenheim", "Holstein Kiel", "RB Leipzig", "Mainz 05", "Borussia Mönchengladbach", "St. Pauli", "VfB Stuttgart", "Union Berlin", "VfL Wolfsburg"];
...
const amsTier1_4 = ["América", "Atlas", "Atlético San Luis", "Cruz Azul", "Guadalajara", "Juárez", "León", "Mazatlán", "Monterrey", "Tigres UANL", "Necaxa", "Pachuca", "Puebla", "Querétaro", "Santos Laguna", "Tijuana", "Toluca", "UANL", "UNAM"];
...
const teams = {
    "hockey": Array.from(new Set([
        ...
        // KHL
        "Ak Bars Kazan", "Avtomobilist Yekaterinburg", "Barys Nur-Sultan", "CSKA Moscow", "Dinamo Minsk", "Dinamo Riga", "HC Admiral Vladivostok", "HC Dynamo Moscow", "HC Lada Togliatti", "HC Neftekhimik Nizhnekamsk", "HC Sibir Novosibirsk", "Jokerit Helsinki", "Traktor Chelyabinsk", "Lokomotiv Yaroslavl", "Avangard Omsk", "Kunlun Red Star", "Metallurg Magnitogorsk", "Nizhny Novgorod Torpedo", "Salavat Yulaev Ufa", "Shanghai", "Sibir Novosibirsk", "Spartak Moscú", "SKA Saint Petersburg", "Slovan Bratislava", "Severstal Cherepovets", "Sochi", "Vityaz Podolsk", "Amur Khabarovsk",
        // SHL
