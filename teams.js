...
const bundesligaTeams = ["Bayern Munich", "Bayer Leverkusen", "VfB Stuttgart", "RB Leipzig", "Borussia Dortmund", "Eintracht Frankfurt", "SC Freiburg", "TSG Hoffenheim", "Werder Bremen", "VfL Wolfsburg", "Union Berlin", "Borussia Mönchengladbach", "FC Augsburg", "Hamburg", "Mainz 05", "VfL Bochum", "1. FC Heidenheim", "FC St. Pauli", "Holstein Kiel"];
const laLigaTeams = ["Real Madrid", "Barcelona", "Girona", "Atlético de Madrid", "Athletic Club", "Real Sociedad", "Real Betis", "Villarreal", "Valencia", "Getafe", "Osasuna", "Mallorca", "Las Palmas", "Sevilla", "Alavés", "Rayo Vallecano", "Celta de Vigo", "Valladolid", "Leganés", "Espanyol"];
